...
2 - Na Activity JAVA do objeto a ser animado:
	...
	btnsub.setOnClickListener(new View.OnClickListener() {
	    ...
	    @Override
            public void onClick(View param1view) { 						// BALANÇO

                YoYo.with(Techniques.Swing).duration(700).playOn(Main2Activity.this.textview); // animação propriamente 
